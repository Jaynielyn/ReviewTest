                    ...
                    <div class="confirm__table">
                        <table class="table__inner">
                            ...
                            <tr class="table__row">
                                ...
                                <td class="table__text">
                                    <input class="gender__name" type="text" name="gender" style="transform:scale(2.0);" value="{{ $contact['gender'] }}" readonly />
                                </td>
                            </tr>
                            <tr class="table__row">
                            ...
                            <tr class="table__row">
                                ...
                                <td class="table__text">
                                    <input class="tel" type="tel" name="tell" value="{{ $contact['tel'] }}" readonly />
                                </td>
                            </tr>
                            <tr class="table__row">
                            ...
                            <tr class="table__row">
                                ...
                                <td class="table__text">
                                    <input class="select" type="text" name="select">
                                </td>
                            </tr>
                            <tr class="table__row">
