                ...
                <div class="contact__form-page">
                    <form class="form" action="/contacts/confirm" method="post">
                        ...
                        <div class="name__form">
                            <input type="text" name="first-name" placeholder="例:山田" class="first-name">
                            <input type="text" name="last-name" placeholder="例:太郎" class="last-name">
                        </div>
                        <div class="gender__form">
                            <input class="gender__name" type="radio" name="gender" style="transform:scale(2.0);"><label for="male">男性</label>
                            <input class="gender__name" type="radio" name="gender" style="transform:scale(2.0);"><label for="female">女性</label>
                            <input class="gender__name" type="radio" name="gender" style="transform:scale(2.0);"><label for="other">その他</label>
                        </div>
                        <div class="mail__form">
                            <input class="email" type="mail" name="email" placeholder="例:test@example.com" size="95">
                        </div>
                        <div class="tel__form">
                        ...
                        <div class="address__form">
                            <input class="address" type="text" name="address" placeholder="例:東京都渋谷区千駄々谷1-2-3" size="95">
                        </div>
                        <div class="building__form">
                            <input class="building" type="text" name="building" placeholder="例:千駄々谷マンション101" size="95">
                        </div>
